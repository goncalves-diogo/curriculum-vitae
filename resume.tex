...
\begin{document}
	...
	\begin{cvsection}{Employment}
		\begin{cvsubsection}{Bsolus}{}{October 2020 -- Present}
			Software Engineer
			\begin{itemize}
                \item Designed and developed a Marketing Automation system based on a microservices architecture with horizontal scalability. Development the CI/CD pipeline integrating with the Google Cloud Platform.
                \item Maintained E-commerce platforms.
                \item Techonologies utilized included: NestJs, TypeScript, PHP, SQL, MongoDB, Terraform, GCP, Bitbucket, Jira, Git.
			\end{itemize}
		\end{cvsubsection}
	\end{cvsection}
